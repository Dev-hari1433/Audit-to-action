    ...
    <main className="min-h-screen bg-[#f6f8f5] text-[#17231d]">
      ...
      <section className="bg-[#12382d] py-20 text-white">
        <div className="mx-auto grid max-w-7xl gap-10 px-5 sm:px-8 lg:grid-cols-[.9fr_1.1fr] lg:px-10 lg:items-center">
          <div><div className="flex w-fit items-center gap-2 rounded-full bg-white/10 px-3 py-2 text-xs font-black uppercase tracking-[.18em] text-[#bcd8ce]"><Sparkles size={15} />AI assistance — optional</div><h2 className="mt-5 text-4xl font-black tracking-tight">Useful help. Never the final word.</h2><p className="mt-4 max-w-xl leading-7 text-[#c9ddd5]">Photo analysis, voice reporting, before/after comparison and complaint classification can speed up work. The complete manual workflow always remains available.</p><div className="mt-7 inline-flex items-center gap-3 rounded-xl border border-[#f29b75]/30 bg-[#e15f2a]/15 px-4 py-3 font-black text-[#ffb492]"><Eye size={20} />AI assists. Humans decide.</div></div>
